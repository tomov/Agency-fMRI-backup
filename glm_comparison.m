        ...
        % BAD
        masks = {...
            '../Momchil/VS_Sphere4_manual_min.nii', ...
            '../Momchil/Put_Sphere4_manual_max.nii', ...
        };


        % correct S3
        masks = { ...
            '../Momchil/S3_Put_L_ROI_x=-30_y=-4_z=10_33voxels_Sphere4.nii', ...
            '../Momchil/S3_Put_R_ROI_x=28_y=-14_z=2_33voxels_Sphere4.nii', ...
        };
        %unify_masks(masks, '../Momchil/S3_Put_Sphere4.nii');

        masks = { ...
            '../Momchil/S3_VS_L_ROI_x=-14_y=8_z=-12_33voxels_Sphere4.nii', ...
            '../Momchil/S3_VS_R_ROI_x=14_y=8_z=-12_33voxels_Sphere4.nii', ...
        };
        %unify_masks(masks, '../Momchil/S3_VS_Sphere4.nii');

        masks = {...
            '../Momchil/S3_VS_Sphere4.nii', ...
            '../Momchil/S3_Put_Sphere4.nii', ...
        };

        % S1
        masks = {...
            '../Momchil/S1_Put_L_ROI_x=-28_y=2_z=2_33voxels_Sphere4.nii', ...
            '../Momchil/S1_Put_R_ROI_x=28_y=-14_z=2_33voxels_Sphere4.nii', ...
        };
        %unify_masks(masks, '../Momchil/S1_Put_Sphere4.nii');

        masks = {...
            '../Momchil/S1_VS_L_ROI_x=-16_y=8_z=-14_33voxels_Sphere4.nii', ...
            '../Momchil/S1_VS_R_ROI_x=14_y=8_z=-12_33voxels_Sphere4.nii', ...
        };
        %unify_masks(masks, '../Momchil/S1_VS_Sphere4.nii');

        masks = {...
            '../Momchil/S1_VS_Sphere4.nii', ...
            '../Momchil/S1_Put_Sphere4.nii', ...
        };

        %{
        masks = {...
            '../Momchil/S1_Put_L_ROI_x=-28_y=2_z=2_160voxels_Sphere10.nii', ...
            '../Momchil/S1_Put_R_ROI_x=28_y=-14_z=2_162voxels_Sphere10.nii', ...
        };
        %unify_masks(masks, '../Momchil/S1_Put_Sphere10.nii');

        masks = {...
            '../Momchil/S1_VS_L_ROI_x=-16_y=8_z=-10_132voxels_Sphere10.nii', ...
            '../Momchil/S1_VS_R_ROI_x=14_y=8_z=-12_57voxels_Sphere10.nii', ...
        };
        %unify_masks(masks, '../Momchil/S1_VS_Sphere10.nii');

        masks = {...
            '../Momchil/S1_VS_Sphere10.nii', ...
            '../Momchil/S1_Put_Sphere10.nii', ...
        };
