...
% missing trials, missing runs, bad img data quality, and modeling issues% (i.e., psi parameter always 1 because they only chose one option for
% every trial)
% S1
...
% behavioral accuracy criteria but did not have any QC imaging issues
% n = 26
%S6
